...
* `$ pkg install python`
* `$ pkg install git`
* `$ git clone https://github.com/VARGAS0404/terkey`
* `$ cd terkey`
* `$ python terkey.py`
...
```pkg update && pkg upgrade;pkg install python git;git clone https://github.com/VARGAS0404/terkey;cd terkey;python terkey.py```
